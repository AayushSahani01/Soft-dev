  ...
  return (
    <>
      <div className="footer ">
            ...
            <div className="flex-col justify-center items-center space-y-4 w-1/3">
              ...
              <div className="flex justify-start items-center space-x-6">
                ...
                <span className="cursor-pointer ">
                  <Twitter className="w-6 h-6 text-blue-500 fill-blue-400 hover:text-blue-600 hover:scale-[1.3] transition-all duration-300 ease-in-out" />
                </span>
                {/* <span className="cursor-pointer ">
        ...
        <div className="grid grid-flow-col px-[4%] py-8 gap-8">
        ...
        <div className=" border-t-2 border-gray-100 mx-[6%] my=[6%]">
          <div className="flex flex-nowrap justify-between items-center pt-6 m-1 pb-8">
            <span className="self-center text-lg whitespace-nowrap dark:text-slate-400 font-light">
